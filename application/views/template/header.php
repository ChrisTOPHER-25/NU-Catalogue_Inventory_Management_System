...
<head>
    <meta charset="utf-8">
    <title><?php if(isset($page_name)) {echo $page_name .' - Sales And Inventory System';} else echo "Dashboard - NU Catalogue SALES AND INVENTORY SYSTEM" ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" href="<?php echo base_url('assets/nuicon.png'); ?>" type="image/png">
